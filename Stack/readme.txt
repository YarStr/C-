...
Примечание:
- Операция возведения в степень в реализованной программе имеет левую ассоциативность. Т.е. выражение 2^2^3 = 64
...
Помимо этого, существует операция Forget, позволяющая забыть всю историю изменений. После Forget нумерация операций начинается с начала, Forget нельзя откатить.
